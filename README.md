...
- `visuals/`:Includes visualization images where Box Plot illustrates the relationship between GDP and happiness across regions, Scatter Plot Matrix shows how happiness relates to key social and economic factors, Bubble Chart presents changes in happiness, GDP, and population over time, and Regression Plot displays predicted versus actual happiness levels.
- `scripts/`: Contains source code for generating visualizations and data analysis. 
- `index.html`: The main webpage used to present the project and visualizations via GitHub Pages.
